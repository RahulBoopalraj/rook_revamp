      ...
      <div className="row g-lg-4 gy-5">
        <div className="col-lg-4 col-sm-6">
          <div className="single-process">
            ...
            <div className="content">
              <h3>Strategy</h3>
              <p>Analyze the client's industry, competitors, and target audience</p>
              <ul>
                <li><i className="bi bi-plus" /> Initial Consultation.</li>
                <li><i className="bi bi-plus" /> Market Research.</li>
        ...
        <div className="col-lg-4 col-sm-6">
          <div className="single-process">
            ...
            <div className="content">
              <h3>Sketch &amp; Design</h3>
              <p>Define the user experience (UX) and user interface (UI) design.</p>
              <ul>
        ...
        <div className="col-lg-4 col-sm-6">
          <div className="single-process">
            ...
            <div className="content">
              <h3>Development</h3>
              <p>Implement coding, scripting, and programming as needed.</p>
              <ul>
                <li><i className="bi bi-plus" /> Design Implementation.</li>
                <li><i className="bi bi-plus" /> Testing &amp; Fixing.</li>
                <li><i className="bi bi-plus" /> Product Launch</li>
              </ul>
            </div>
          </div>
        </div>
