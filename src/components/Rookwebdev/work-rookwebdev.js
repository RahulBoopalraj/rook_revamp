      ...
      <div className="container-lg container-fluid">
          ...
          <div className="col-xl-7 col-lg-10">
            <div className="paragraph-and-btn-area">
              <div className="text-animation">
                <p>
                  Crafting a customer-centric brief for your website is crucial.
                  We focus on understanding your business needs to succeed
                  online.
                </p>
              </div>
            </div>
        ...
        <div className="work-wrapper">
          ...
          <div className="duration">
            <h6>
              Selected work *<span>(2022-24)</span>
            </h6>
          </div>
                    ...
                    <div className="work-card magnetic-item">
                      <div className="work-img">
                        <Link href="/portfolio-details">
                          <img
                            src="assets/img/home5/work-card-img1.jpg"
                            alt=""
                          />
                        </Link>
                        <div className="batch">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="work-card magnetic-item">
                      <div className="work-img">
                        <Link href="/portfolio-details">
                          <img
                            src="assets/img/home5/work-card-img2.jpg"
                            alt=""
                          />
                        </Link>
                        <div className="batch">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="work-card magnetic-item">
                      <div className="work-img">
                        <Link href="/portfolio-details">
                          <img
                            src="assets/img/home5/work-card-img3.jpg"
                            alt=""
                          />
                        </Link>
                        <div className="batch">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="work-card magnetic-item">
                      <div className="work-img">
                        <Link href="/portfolio-details">
                          <img
                            src="assets/img/home5/work-card-img4.jpg"
                            alt=""
                          />
                        </Link>
                        <div className="batch">
                          <span>Capital Engineering Consultancy </span>
                        </div>
                      </div>
                      <div className="work-content">
                        <h5>
                          <Link href="/portfolio-details">
                          https://capitalengg.in
                          </Link>
                        </h5>
                      </div>
                    </div>
